...
public class MainGUI {
    ...
    JPanel medicLoginPanel(String title) {
        ...
        loginButton.addActionListener(e -> {
            ...
            boolean autenticat = doctorDAO.autentificareDoctor(email, parola);

            if (autenticat) {
                JOptionPane.showMessageDialog(mainFrame, "Autentificare reușită!");
    ...
    public JPanel signUpPanel() {
        ...
        btnSignUp.addActionListener(e -> {
            ...
            try {
                ...
                DoctorDAO doctorDAO = new DoctorDAO();
                doctorDAO.adaugaDoctor(nume, email, parola, specializare);
                JOptionPane.showMessageDialog(panel, "Contul a fost creat cu succes!", "Succes", JOptionPane.INFORMATION_MESSAGE);
    ...
    JPanel pacientLoginPanel(String title) throws SQLException {
        ...
        if (connection == null || connection.isClosed()) {
            ...
            loginButton.addActionListener(e -> {
                ...
                Pacient pacient = pacientDAO.PacientCNP(nume, cnp);
             ...
             if (option == JOptionPane.OK_OPTION) {
                 try {
                     ...
                     try (PreparedStatement stmt = BazaDeDate.getConnection().prepareStatement(sql)) {
                         ...
                         if (rowsAffected > 0) {
                             JOptionPane.showMessageDialog(mainFrame, "Pacient adăugat cu succes!");
                         } else {
    ...
    void CautaPacient() throws SQLException {
            ...
            //Functionalitate pentru butonul de cautare
             butonCauta.addActionListener(e -> {
                 ...
                 try {
                     rezultate = cautaPacienti(criteriu, valoare);
                 } catch (SQLException ex) {
        ...
        butonProgrameaza.addActionListener(e -> {
            ...
            try {
                ...
                try (PreparedStatement stmt = connection.prepareStatement(sql)) {
                    ...
                    JOptionPane.showMessageDialog(frame, "A apărut o eroare la actualizarea programării: " + SQLex.getMessage(), "Eroare", JOptionPane.ERROR_MESSAGE);
                }
    ...
    try {
        boolean rezultat = pacientDAO.stergePacient(cnp);
        if (rezultat) {
